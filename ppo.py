...
class PPO():
    ...
    def __init__(self, input_shape, num_actions,
        ...
        # Create placeholders
        self.input_states  = tf.compat.v1.placeholder(shape=(None, *input_shape), dtype=tf.float32, name="input_state_placeholder")
        self.taken_actions = tf.compat.v1.placeholder(shape=(None, num_actions), dtype=tf.float32, name="taken_action_placeholder")
        self.returns   = tf.compat.v1.placeholder(shape=(None,), dtype=tf.float32, name="returns_placeholder")
